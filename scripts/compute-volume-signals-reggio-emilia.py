...
VOL_JSON = ROOT / "data" / "volumi" / "reggio-emilia-volumi-timeseries.json"
MAP_JSON = ROOT / "data" / "volumi" / "zone-mapping-old-new-reggio-emilia.json"
SIG_JSON = ROOT / "data" / "computed" / "reggio-emilia-signals.json"
OUT_JSON = ROOT / "data" / "computed" / "reggio-emilia-volume-signals.json"
...
def main():
    ...
    payload = {
        "metadata": {
            ...
            "source": "data/volumi/reggio-emilia-volumi-timeseries.json (PDF AdE Statistiche Regionali Emilia-Romagna) + data/computed/reggio-emilia-signals.json (Sagona OMI quotazioni)",
