...
VOL_JSON = ROOT / "data" / "volumi" / "bologna-volumi-timeseries.json"
MAP_JSON = ROOT / "data" / "volumi" / "zone-mapping-old-new-bologna.json"
SIG_JSON = ROOT / "data" / "computed" / "bologna-signals.json"
OUT_JSON = ROOT / "data" / "computed" / "bologna-volume-signals.json"
...
def main():
    ...
    payload = {
        "metadata": {
            ...
            "source": "data/volumi/bologna-volumi-timeseries.json (PDF AdE Statistiche Regionali Emilia-Romagna) + data/computed/bologna-signals.json (Sagona OMI quotazioni)",
